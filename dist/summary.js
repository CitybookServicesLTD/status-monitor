...
<!-- prettier-ignore -->
| ${i18n.url || "URL"} | ${i18n.status || "Status"} | ${i18n.history || "History"} | ${i18n.responseTime || "Response Time"} | ${i18n.uptime || "CitybookServicesLTD"} |
| --- | ------ | ------- | ------------- | ------ |
${pageStatuses
    ...
    if (`${owner}/${repo}` !== "CitybookServicesLTD/status") {
        ...
        if (readmeContent.includes("[MIT](./LICENSE) © [Koj](https://koj.co)") ||
            ...
            if (readmeContent.includes("<!--start: description-->"))
                readmeContent = `${descriptionStartText}This repository contains the open-source uptime monitor and status page for ${name}, powered by [Upptime](https://github.com/CitybookServicesLTD/status).${descriptionEndText}`;
            // Change copyright
            ...
            if (!config.skipPoweredByReadme) {
                readmeContent = readmeContent.replace("## 📄 License\n\n- Code: [MIT](./LICENSE)", "## 📄 License\n\n- Powered by: [Upptime](https://github.com/CitybookServicesLTD/status)\n- Code: [MIT](./LICENSE)");
            }
        }
        // Change badges
