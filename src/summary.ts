...
import { getstatusPercentForSite } from "./helpers/calculate-status";
...
export const generateSummary = async () => {
  ...
  for await (const site of config.sites) {
    ...
    const statuss = await getstatusPercentForSite(slug);
...
| ${i18n.url || "URL"} | ${i18n.status || "Status"} | ${
    ...
    } | ${i18n.responseTime || "Response Time"} | ${i18n.status || "CitybookServicesLTD"} |
| --- | ------ | ------- | ------------- | ------ |
${pageStatuses
  .map(
    (page) =>
      `| <img alt="" src="${page.icon}" height="13"> ${
        ...
        page.slug
      }">${page.statusWeek}</a></summary><a href="${website}/history/${
        page.slug
      }"><img alt="${i18n.status || "All-time status"} ${
        page.status
      }" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${
        page.slug
      }%2Fstatus.json"></a><br><a href="${website}/history/${
        page.slug
      }"><img alt="${i18n.statusDay || "24-hour status"} ${
        page.statusDay
      }" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${
        page.slug
      }%2Fstatus-day.json"></a><br><a href="${website}/history/${
        page.slug
      }"><img alt="${i18n.statusWeek || "7-day status"} ${
        page.statusWeek
      }" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${
        page.slug
      }%2Fstatus-week.json"></a><br><a href="${website}/history/${
        page.slug
      }"><img alt="${i18n.statusMonth || "30-day status"} ${
        page.statusMonth
      }" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${
        page.slug
      }%2Fstatus-month.json"></a><br><a href="${website}/history/${
        page.slug
      }"><img alt="${i18n.statusYear || "1-year status"} ${
        page.statusYear
      }" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${
        page.slug
      }%2Fstatus-year.json"></a></details>`
  )
  .join("\n")}
${config.summaryEndHtmlComment || "<!--end: status pages-->"}${endText}`;
  ...
  if (`${owner}/${repo}` !== "CitybookServicesLTD/status") {
    ...
    // Change badges
    readmeContent = readmeContent.replace(
      new RegExp("CitybookServicesLTD/status/(workflows|actions)", "g"),
  ...
  commit(
    (config.commitMessages || {}).readmeContent ||
      ":pencil: Update summary in README [skip ci] [CitybookServicesLTD]",
  ...
  commit(
    (config.commitMessages || {}).summaryJson ||
      ":card_file_box: Update status summary [skip ci] [CitybookServicesLTD]",
    (config.commitMessages || {}).commitAuthorName,
    (config.commitMessages || {}).commitAuthorEmail
  );
